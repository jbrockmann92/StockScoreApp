...
namespace StockScore.Controllers
{
    public class FavoritesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StockSymbol,TimeFrame,UserId")] Favorites favorites)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StockSymbol,TimeFrame,UserId")] Favorites favorites)
        {
            if (id != favorites.Id)
            {
                return NotFound();
